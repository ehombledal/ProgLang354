All programs compute the same thing. 500,000 entries in an array, filled with
integers between 1-9. Add 1 to each index, then sum list. 

INSTRUCTIONS ON RUNNING PROGRAMS 

Java Instructions: Javac JavaPaperExample.java -> java JavaPaperExample
